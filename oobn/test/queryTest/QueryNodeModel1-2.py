...
if __name__ == '__main__':
    ...
    result5, t5 = ooBNQuery.localInference(["No_working_signal"], ooBNTest.objectNodes[2],
                                           ...
                                           counts=500)
    print(f"CTP算法的时间为{tBP}")
    print(f"VE算法的时间为{tVE}")
    print(f"全局算法的时间为{tGL}")
    t = [tGL[i] + max(values) for i, values in enumerate(zip(t1, t2, t3, t4, t5))]
    print(f"新算法的时间为{t}")
    # timeComparision(tVE, tBP, t)
    # detailTime(tGL, {"Iron_filings_1": t3,
    #                  "Low_fuel_injector_pressure": t4, "No_working_signal": t5, "Pressure_rise_limiter": t1,
    #                  "Low_protection_value": t2, })
    # detailTime(tGL, {"Pressure_rise_limiter": t1, "Low_protection_value": t2, "Iron_filings_1": t3,
    #                  "Low_fuel_injector_pressure": t4,
    #                  })
