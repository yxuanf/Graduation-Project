...
if __name__ == '__main__':
    ...
    nodes = [
        ...
        "Iron_filings_1",
        # "Breakdown_shutdown_1",
        "Oil_leak_1",
        # "Pressure_difference_1",
        ...
        # "Pressure_fluctuations_2",
        # "Oil_leak_2",

        "Injector_pressure_fluctuation",

        # "No_power_on_signal",
        # "Thermostat_check_abnormality",
    ...
    result1, t1 = ooBNQuery.localInference(["Pressure_rise_limiter",
                                            "Unable_to_adjust_fuel",
                                            # "Valve_components"
                                            ], ooBNTest.objectNodes[5],
                                           {"Throttle_component": p1},
                                           counts=50)
    result2, t2 = ooBNQuery.localInference(["Low_protection_value",
                                            "Thermostat_failure",
                                            # "No_power_on_signal"
                                            ], ooBNTest.objectNodes[3],
                                           {"Thermostat_circuit_disconnected": np.array([0, 1]),
                                            "On_signal_off": np.array([0, 1])},
                                           counts=50)
    result3, t3 = ooBNQuery.localInference(["Iron_filings_1",
                                            # "Breakdown_shutdown_1",
                                            "Oil_leak_1",
                                            # "Pressure_difference_1"
                                            ], ooBNTest.objectNodes[-2],
    ...
    result4, t4 = ooBNQuery.localInference(["Low_fuel_injector_pressure"], ooBNTest.objectNodes[0],
                                           ...
                                           counts=50)
    result5, t5 = ooBNQuery.localInference(["No_working_signal",
                                            "Thermostat_check_abnormality"
                                            ],
                                           ooBNTest.objectNodes[2],
                                           ...
                                           counts=50)
    result6, t6 = ooBNQuery.localInference(["Iron_filings_2",
                                            "Shaft_seal_damaged_2",
                                            # "Pressure_fluctuations_2",
                                            # "Oil_leak_2"
                                            ], ooBNTest.objectNodes[-1],
    ...
    t = [tGL[i] + max(values) for i, values in enumerate(zip(t1, t2, t3, t4, t5, t6))]
    print(f"新算法的时间为{t}")
    timeComparision(tVE, tBP, t)
    detailTime(tGL, {
        # "Start_fueling": t7,
        "Low_fuel_injector_pressure": t4, "No_working_signal": t5, "Gear_pump_2": t6,
        "Pressure_rise_limiter": t1, "Low_protection_value": t2, "Iron_filings_1": t3, })
